    ...
    <section id="contact" className="py-20 bg-background">
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
              ...
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a 
                      href="mailto:info@thikablueroses.ac.ke" 
                      className="text-muted-foreground hover:text-primary transition-colors"
                    >
          ...
          {/* QR Code and School Image */}
          <div className="space-y-6">
            <Card className="overflow-hidden">
              <div className="relative h-64">
                <Image
                  src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/upscalemedia-transformed%20%281%29-J75LbolBzr3SE982Q9DQvKNCffEtyI.jpeg"
              ...
              <CardContent className="p-6">
                <h3 className="font-semibold text-foreground mb-2">Visit Our School</h3>
            ...
            <Card>
              <CardContent className="p-6 text-center">
                <h3 className="font-semibold text-foreground mb-4">Follow Us on TikTok</h3>
                <div className="bg-white p-4 rounded-lg inline-block mx-auto">
                  <Image
                    src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-aP5LlHVKrDDPAZEoFdS8DC746mlW2z.png"
                    alt="TikTok QR Code - @thikablueroses"
                    width={180}
                    height={180}
                    className="mx-auto"
                  />
